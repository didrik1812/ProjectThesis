...
# ! /C:/Users/didri/OneDrive - NTNU/9.semester/Prosjekt/ProjectThesis/code/dataloader.R --vanilla --default-packages=utils
...
if (!require(SMisc)) {
    install.packages("C:\\Users\\didri\\OneDrive - NTNU\\9.semester\\Prosjekt\\ProjectThesis\\code\\SMisc.tar.gz", repos = NULL, type = "source")
}
...
if (!require(MCMCglmm)) {
    install.packages("MCMCglmm", repos = "http://cran.us.r-project.org", type = "binary")
}
if (!require(feather)) {
